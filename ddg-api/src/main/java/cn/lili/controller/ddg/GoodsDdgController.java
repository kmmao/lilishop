...
public class GoodsDdgController {
    ...
    @Autowired
    private DdgParentsAssignGoodsSkuService goodsSkuDdgService;
    ...
    public ResultMessage<Object> assignGoodsSku(DdgParentsAssignGoodsSkuVO ddgParentsAssignGoodsSkuVO) {
        return ResultUtil.data(goodsSkuDdgService.assignGoodsSku(ddgParentsAssignGoodsSkuVO));
    }
    ...
    public ResultMessage<IPage<GoodsSku>> getGoodsSkuByChildId(GoodsDdgSearchParams searchParams) {
        return ResultUtil.data(goodsSkuDdgService.goodsSkuPageByChildId(searchParams));
    }
...
//        return ResultUtil.data(goodsSkuDdgService.childApplyBuy(ddgChildApplyBuyVO));
//    }
