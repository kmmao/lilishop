 ...
 * @author Allen
 * @version v4.1
 * @since 2022/10/19 3:37 下午
 * @since
 */
@Slf4j
public class DdgAuthenticationFilter extends BasicAuthenticationFilter {
     ...
     * @param cache
     */
    public DdgAuthenticationFilter(AuthenticationManager authenticationManager,
                                   Cache cache) {
